...
// @access  Private
router.post('/', passport.authenticate('jwt-admin', { session: false }), addShippingMethod);

// @route   PUT /shipping-methods/:customId
// @desc    Update existing shipping method
// @access  Private
router.put('/:customId', passport.authenticate('jwt-admin', { session: false }), updateShippingMethod);

// @route   DELETE /shipping-methods/:customId
// @desc    DELETE existing shipping method
// @access  Private
router.delete('/:customId', passport.authenticate('jwt-admin', { session: false }), deleteShippingMethod);
