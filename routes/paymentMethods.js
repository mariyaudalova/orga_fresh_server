...
// @access  Private
router.post('/', passport.authenticate('jwt-admin', { session: false }), addPaymentMethod);

// @route   PUT /payment-methods/:customId
// @desc    Update existing payment method
// @access  Private
router.put('/:customId', passport.authenticate('jwt-admin', { session: false }), updatePaymentMethod);

// @route   DELETE /payment-methods/:customId
// @desc    DELETE existing payment method
// @access  Private
router.delete('/:customId', passport.authenticate('jwt-admin', { session: false }), deletePaymentMethod);
